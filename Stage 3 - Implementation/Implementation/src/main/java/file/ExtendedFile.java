...
public class ExtendedFile extends File {
    ...
    public static final String SAVES_PATH = System.getProperty("user.home")
        + File.separator + ".jordan/saves/";
     ...
     */
    public void remove() throws FileCanNotDeleteException, IOException {
        if (!exists()) {
