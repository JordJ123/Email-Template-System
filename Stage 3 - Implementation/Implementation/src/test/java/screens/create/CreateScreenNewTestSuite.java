 ...
 * @author Jordan Jones
 */
public class CreateScreenNewTestSuite extends CreateScreenTestSuite {
    ...
    /**
     * FUNCTIONAL 1-33+37 + NON-FUNCTIONAL 1-15+17+19-22+25
    ...
    /**
     * FUNCTIONAL 1-25+34+37 + NON-FUNCTIONAL 1-15+17+19-22+25
    ...
    void onSendButtonNoTags(@NotNull FxRobot robot) {
        ...
        Assertions.assertThat(robot.lookup(SCREEN_SPACE)
            .queryAs(Pane.class).getChildren().size()).isEqualTo(0);
    }

    /**
     * FUNCTIONAL 1-32+36-37 + NON-FUNCTIONAL 1-15+17+19-22+25
     * Tests if the send button goes to the tag screen.
     * @param robot Robot that uses the program
     */
    @Test
    ...
    /**
     * FUNCTIONAL 1-25+36-37 + NON-FUNCTIONAL 1-15+17+19-22+25
     * Tests if the send button sends the email correctly.
     * @param robot Robot that uses the program
     */
    @Test
