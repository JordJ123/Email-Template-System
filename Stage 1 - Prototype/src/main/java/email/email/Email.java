...
public class Email implements Serializable {
     ...
     * @param session Session to generate the message for
     ...
     */
    public MimeMessage generateMessage(Session session)
        throws IOException, MessagingException {
        MimeMessage message = new MimeMessage(session);
        message.setSender(new InternetAddress(
            Main.getLoggedInAccount().getEmailAddress().getAddress()));
     ...
     * @throws MessagingException Thrown if issue with generating message
     */
    public MimeMessage generateMessageWithTags(Session session,
